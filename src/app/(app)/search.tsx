...
import { Animated, FlatList, Pressable, StyleSheet, TextInput } from 'react-native';
...
export default function Search() {
  ...
  const { registerRow, handleScroll, getRowOpacity, onViewableItemsChanged, viewabilityConfig } =
    useScrollReveal();
  ...
  const suggestions = (
    <ThemedView style={styles.suggestions}>
      {recent.length > 0 && (
        <Animated.View {...registerRow('recent-searches')}>
      ...
      <Animated.View {...registerRow('popular-searches')}>
        <ThemedView style={styles.suggestionSection}>
          <ThemedText type="smallBold" style={styles.suggestionHeading}>
            Popular Searches
          </ThemedText>
